...

{
  "data": {
    ...
    "attributes": {
      "deposit_agreement_accepted_at": "2019-02-13T02:55:58.659-05:00",
...
```http
PATCH /api/financial_profiles/2/accept_deposit_agreement HTTP/1.1
Accept: application/json
Host: roomeze.com
```
```http
...
This endpoint allows a user to accept the deposit agreement

### HTTP Request

`PATCH https://roomeze.com/api/financial_profiles/<ID>/accept_deposit_agreement`
